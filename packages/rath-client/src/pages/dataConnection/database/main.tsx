...
interface DatabaseDataProps {
    onClose: () => void;
    onDataLoaded: (fields: IMuteFieldBase[], dataSource: IRow[], name: string, tag: DataSourceTag, withHistory?: undefined, recipe?: IDataFetchRecipe) => void;
}
    ...
    const submit = async (
        ...
        try {
            ...
            const recipe: IDataFetchRecipe = {
                type: 'database',
                dbServer: server,
                dbSourceType: sourceType,
                dbUri: connectUri,
                dbQuery: queryString,
                dbCredentials: credentials,
            };
            onDataLoaded(fields, dataSource, name, DataSourceTag.DATABASE, undefined, recipe);
