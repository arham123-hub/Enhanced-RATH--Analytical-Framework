...
interface JSONAPIProps {
    ...
    onDataLoaded: (fields: IMuteFieldBase[], dataSource: IRow[], name: undefined, tag: DataSourceTag, withHistory?: undefined, recipe?: IDataFetchRecipe) => void;
}
    ...
    async function confirmData() {
        ...
        if (typeof error === 'undefined') {
            const recipe: IDataFetchRecipe = {
                type: 'restful',
                apiUrl: api,
                apiFormat: detectedDataStruct,
            };
            onDataLoaded(fields, dataSource, undefined, DataSourceTag.RESTFUL, undefined, recipe);
            logDataImport({
                dataType: 'JSON API',
                name: api,
                fields,
