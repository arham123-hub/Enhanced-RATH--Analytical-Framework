...
import { IMuteFieldBase, IRow, IDataFetchRecipe } from '../../../interfaces';
...
import BigFileData from './bigFile';
...
interface SelectionProps {
    ...
    onDataLoaded: (fields: IMuteFieldBase[], dataSource: IRow[], name?: string, tag?: DataSourceTag | undefined, withHistory?: IDBMeta | undefined, recipe?: IDataFetchRecipe) => void;
...
const Selection: React.FC<SelectionProps> = props => {
    ...
    const formMap: Record<IDataSourceType, JSX.Element> = {
        ...
        [IDataSourceType.BIG_FILE]: (
            <BigFileData onClose={onClose} onDataLoaded={onDataLoaded} onLoadingFailed={onLoadingFailed} toggleLoadingAnimation={setLoadingAnimation} />
        ),
