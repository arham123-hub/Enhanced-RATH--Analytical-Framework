...
import { IResizeMode, IRow, ISpecSourceType, IVisView, RealTimeStatus } from "../../interfaces";
...
export class SemiAutomationStore {
    ...
    public init () {
        ...
        this.reactions.push(reaction(() => {
            ...
            if (
                this.dataSourceStore.realTimeStatus === RealTimeStatus.RUNNING &&
                !this.dataSourceStore.realTimeConfig.autoRetrigger.semiAuto
            ) return;
