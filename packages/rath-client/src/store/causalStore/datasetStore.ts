    ...
    constructor(dataSourceStore: DataSourceStore) {
        ...
        const mobxReactions = [
            ...
            reaction(() => dataSourceStore.cleanedData, cleanedData => {
                // Skip re-sampling during real-time updates when causal autoRetrigger is off
                if (
                    dataSourceStore.realTimeStatus === RealTimeStatus.RUNNING &&
                    !dataSourceStore.realTimeConfig.autoRetrigger.causal
                ) return;
